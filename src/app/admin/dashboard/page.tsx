...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Header Banner */}
      <div className="rounded-3xl border border-slate-800 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 p-6 md:p-8 space-y-3">
      ...
      <div className="grid gap-5 sm:grid-cols-3">
        <Card className="border-slate-800 bg-slate-950 text-slate-100 rounded-3xl p-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-400 mt-1">Artikel berita & kegiatan</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-slate-800 bg-slate-950 text-slate-100 rounded-3xl p-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-400 mt-1">Foto dokumentasi kegiatan</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-slate-800 bg-slate-950 text-slate-100 rounded-3xl p-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-400 mt-1">Respons / Umpan balik warga</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="space-y-4 rounded-3xl border border-slate-800 bg-slate-950 p-6">
        <h2 className="font-heading text-lg font-bold text-white">Aksi Cepat Admin</h2>
        <div className="flex flex-wrap gap-4">
          <Button
            className="rounded-2xl gap-2 font-bold shadow-md"
          ...
          <Button
            variant="outline"
            className="rounded-2xl gap-2 font-bold border-slate-700 bg-slate-900 text-slate-100 hover:bg-slate-800"
