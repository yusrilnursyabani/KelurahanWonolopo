...
export const serviceCatalog: ServiceItem[] = [
  // Kategori 1: Administrasi & Kependudukan
  {
    ...
    isExternal: false,
    iconName: "Home",
    imageIcon: "/assets/icons/Surat pengatar keterangan umum.png",
    badgeText: "Kelurahan",
  },
  {
    id: "srv-disdukcapil",
  ...
  },
  {
    ...
    title: "Surat Keterangan Kelahiran / Akta Kelahiran",
    slug: "akta-kelahiran",
    description: "Pencatatan kelahiran WNI & Orang Asing (OA) dalam wilayah NKRI serta penerbitan kutipan Akta Kelahiran resmi.",
    category: "administrasi-kependudukan",
    isExternal: false,
    onlineUrl: "https://apelsurga.semarangkota.go.id/doLogin/",
    iconName: "Baby",
    imageIcon: "/assets/icons/Surat keterangan kelahiran.png",
    badgeText: "Apel Surga Online",
  },
  {
    id: "srv-akta-kematian",
    title: "Surat Keterangan Kematian / Akta Kematian",
    slug: "akta-kematian",
    description: "Pencatatan pelaporan kematian WNI & Orang Asing dalam wilayah NKRI dan penerbitan kutipan Akta Kematian.",
    category: "administrasi-kependudukan",
    isExternal: false,
    onlineUrl: "https://apelsurga.semarangkota.go.id/doLogin/",
    iconName: "FileText",
    imageIcon: "/assets/icons/Surat keterangan kematian.png",
    badgeText: "Apel Surga Online",
  },
  {
    id: "srv-perkawinan-perceraian",
    title: "Akta Perkawinan & Akta Perceraian",
    slug: "perkawinan-perceraian",
    description: "Pencatatan peristiwa penting perkawinan dan perceraian bagi WNI serta Orang Asing (Non-Muslim).",
    category: "administrasi-kependudukan",
    isExternal: false,
    onlineUrl: "https://apelsurga.semarangkota.go.id/doLogin/",
    iconName: "Users",
    imageIcon: "/assets/icons/Surat pengatar nikah.png",
    badgeText: "Apel Surga Online",
  },
  {
    id: "srv-perubahan-biodata-kk",
    title: "Perubahan Biodata Kartu Keluarga (KK)",
    slug: "perubahan-biodata-kk",
    description: "Pembaruan data KK untuk keluarga baru, penggantian kepala keluarga, pisah KK, perubahan data, atau KK hilang/rusak.",
    category: "administrasi-kependudukan",
    isExternal: false,
    onlineUrl: "https://apelsurga.semarangkota.go.id/doLogin/",
    iconName: "FileCheck2",
    imageIcon: "/assets/icons/Surat perubahan biodata keluarga.png",
    badgeText: "Apel Surga Online",
  },
  {
    id: "srv-pindah-datang",
    title: "Surat Keterangan Pindah Datang (Kedatangan)",
    slug: "surat-pindah-datang",
    description: "Pencatatan kedatangan penduduk ke wilayah Kelurahan Wonolopo / Kota Semarang dari daerah asal.",
    category: "administrasi-kependudukan",
    isExternal: false,
    onlineUrl: "https://apelsurga.semarangkota.go.id/doLogin/",
    iconName: "Home",
